...
void loop() {
   //readings from MQ7 sensor
    MQ7.update(); 
    MQ7Data=MQ7.readSensor(); 
   /*Serial.println("Concentration of CO: "); //for debugging purpose
    Serial.println(MQ7Data);
   delay(1000);*/
    
  MQ4.update();
  MQ4Data=MQ4.readSensor();
  /*Serial.println("Concentration of Methane: "); //for debugging purpose
  Serial.println(MQ4Data);
  delay(1000);*/

  AQItest=((MQ7Data+MQ4Data)/2.0);
